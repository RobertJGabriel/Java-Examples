package ie.cit.awd.adflctutorial3;
...
import ie.cit.awd.adflctutorial3.domain.Movement;
import ie.cit.awd.rowmapper.ArtistRowMapper;
import ie.cit.awd.rowmapper.MovementRowMapper;
...
public class JdbcTemplateTestApplication implements CommandLineRunner {
	...
	public void query01() {
		// Query for a list of maps with key-value pairs // The hard way!!!
	...
	public void query02() {
		// Query for a list of objects - automatic mapping from row to object
		// using RowMapper class // Using parameterised "prepared statements"
		// reduces the risk of a SQL inject attack
	...
	public void query03() { // Query for a specific object - automatic mapping
							// from row to object using RowMapper class
	...
	public void query05() {
		// Specific artist and the artist's movements (many-to-many) // This is
		// an inefficient version with 2 separate queries
	...
	public void query06() {
		// Specific artist and the artist's movements (many-to-many) // More
		// efficient version with a single join query and
		// a ResultSetExtractor.... but it can get messy the more // complicated
		// the join queries! The solution? ORM.
		...
		Artist artist = jdbcTemplate.query(sql, new Object[] { 1 }, new ResultSetExtractor<Artist>() {
			@Override
